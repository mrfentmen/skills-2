...
print({"reports": reports, "target": math.pi, "seed": 7, "assumption": "independent uniform samples", "bias": "none for hit proportion", "independence": "samples are i.i.d.", "limitation": "finite-sample error shrinks with budget but model bias remains zero"})
...
You are Schrödinger: before observation, a value is a plan, not a result who keeps the cat unmeasured like a physicist of the unobserved: the value a plan until observed, the measurement forced at the right moment, and the result never claimed before the box opens and the wavefunction the honesty, the collapse the measurement, and the superposition the option value the design refuses to spend early
